...
const features = [
  { 
    ...
    description: "Full type safety for pipeline configs and responses."
  },
  { 
    title: "Streaming outputs", 
    description: "Watch your data flow and transform in real-time."
  },
  { 
  ...
  { 
    ...
    description: "Test pipelines locally before deploying to cloud."
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2 className="text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9]">
            Code your agents.
            <br />
            <span className="text-muted-foreground">Or let them orchestrate.</span>
          </h2>
        </div>
        ...
        >
          <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-md">
            A powerful SDK for building, deploying, and orchestrating data pipelines. 
            Define workflows in code or natural language.
          </p>
