...
const metrics = [
  { 
    ...
    suffix: "", 
    prefix: "",
    label: "Insights generated today",
    sublabel: "real-time anomaly detection",
  },
  { 
    value: 98, 
    suffix: "%", 
...
export function MetricsSection() {
  ...
  return (
    <section id="analytics" ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      <GridBackground />
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20 lg:mb-32">
          <div className="lg:col-span-8 lg:col-start-1">
            <div className="flex items-center gap-4 mb-6">
              <span className="flex items-center gap-2 px-3 py-1 bg-[#ec4899]/10 text-[#ec4899] text-xs font-mono">
