...
const securityFeatures = [
  {
    ...
    description: "Each data pipeline runs in its own secure sandbox.",
        ...
        <div className="mb-20">
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Your data pipelines are powerful but constrained. Enterprise-grade security ensures complete data protection.
            </p>
          </div>
        </div>
