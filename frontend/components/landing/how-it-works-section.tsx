...
const steps = [
  {
    ...
    title: "Define",
    subtitle: "your goals",
    description: "Describe your data goals, constraints, and workflows in natural language or code.",
    code: `const pipeline = new DataSage({
  ...
  },
  {
    ...
    title: "Orchestrate",
    subtitle: "the flow",
    description: "Data Sage coordinates tasks across distributed AI agents, breaking complex analytics into executable steps.",
    code: `await pipeline.orchestrate({
  ...
  },
  {
    ...
    title: "Monitor",
    subtitle: "& scale",
    description: "Track performance in real-time and scale orchestration automatically.",
    code: `datasage.monitor({
  pipelines: [pipeline],
  metrics: ['throughput', 'latency', 'cost'],
  autoScale: true
})
// 2.8M insights generated today`,
  },
];
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-8">
                <span className={`text-4xl font-display transition-colors duration-300 ${
                  activeStep === index ? "text-[#ec4899]" : "text-white/20"
                }`}>
                  {step.number}
                </span>
                <div className="flex-1 h-px bg-white/10 overflow-hidden">
                  {activeStep === index && (
                    <div className="h-full bg-[#ec4899]/50 animate-progress" />
                  )}
                </div>
              </div>
              ...
              {/* Active indicator */}
              <div className={`absolute bottom-0 left-0 right-0 h-1 bg-[#ec4899] transition-transform duration-500 origin-left ${
