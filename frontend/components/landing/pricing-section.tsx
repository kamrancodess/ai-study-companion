...
const plans = [
  {
    name: "Explorer",
    description: "For experimenting with data orchestration",
  ...
  {
    name: "Builder",
    description: "For teams shipping with data agents",
  ...
  {
    name: "Scale",
    description: "For data-first organizations",
                  ...
                  <ul className="space-y-3 mb-10">
                    {plan.features.map((feature) => (
                      <li key={feature} className="flex items-start gap-3">
                        <Check className="w-4 h-4 text-[#ec4899] mt-0.5 shrink-0" />
