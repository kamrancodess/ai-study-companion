...
const testimonials = [
  {
    quote: "Data Sage reduced our analytics time from weeks to hours. The ROI was immediate.",
    author: "Sarah Chen",
    role: "CTO",
    company: "Meridian Labs",
    metric: { value: "30x", label: "Faster insights" },
  },
  {
    quote: "We deployed data agents that work 24/7. They surface insights we'd never find manually.",
    author: "Marcus Webb",
  ...
  {
    quote: "The data orchestration is incredible. Complex pipelines that took weeks now run in hours.",
  ...
  {
    quote: "Reduced debugging time drastically. The log analysis AI catches issues before they become problems.",
    author: "James Liu",
    role: "CISO",
    company: "Prism Analytics",
    metric: { value: "$2.4K", label: "Cost savings/mo" },
  },
];
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              <span className="text-background/40"> teams.</span>
            </h2>
          </div>
